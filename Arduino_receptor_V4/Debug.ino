...

{
   if (t)   
   {
      ...
      Serial.print(" Yaw: ");Serial.print(yaw);Serial.print(" Pitch: ");Serial.print(pitch);Serial.print(" Roll: ");Serial.print(roll);
      
      //if (DB_S) {Serial.print(" Timer: ");Serial.print(timer);}
      
      Serial.print(" Kalman:");
      Serial.print(" Yaw: ");Serial.print(pitchPrediction);Serial.print(" Pitch: ");Serial.println(rollPrediction);
